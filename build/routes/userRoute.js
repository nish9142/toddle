...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, requiredKeys, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                payload = req.body || {};
                requiredKeys = ['username', 'password', 'user_type'];
                (0, helpers_1.allRequiredKeysPresent)(requiredKeys, payload, res);
                if (!userRepo_1.USER_TYPE_VALUES.includes(payload.user_type)) {
                    throw new Error("Invalid user_type");
                }
                payload.username = payload.username.toLowerCase();
                return [4 /*yield*/, userRepo_1.UserRepo.createUser(payload)];
            case 1:
                user = _a.sent();
...
router.post('/signin', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, requiredKeys, user, token, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                (0, helpers_1.allRequiredKeysPresent)(requiredKeys, payload, res);
                payload.username = payload.username.toLowerCase();
                return [4 /*yield*/, userRepo_1.UserRepo.findUserByUserName(payload.username)];
            case 1:
                user = _a.sent();
                if (!user || (user === null || user === void 0 ? void 0 : user.password) !== payload.password) {
                    throw new Error('Invalid username or password');
                }
                token = jsonwebtoken_1.default.sign({ user: user }, constants_1.JWT_SECRET_KEY);
